...
function playSound(soundfile) {
 ...
 <section> <!--circle subjects begin-->
			...
			<nav><a href="#">Click for Answer</a></nav>
							...
							<div class="ch-info-wrap">
								<div class="ch-info">
									...
									<div class="ch-info-back">
										<h3>Kids Portal</h3>
										<span id="dummy"></span>
							<nav><a href="kidsportal.html">Click to Enter</a></nav>
							<nav><a onclick="playSound('audio/tada_01.mp3');"><img src="images/listen.png" alt=""></a></nav>											</div>
								</div>
							</div>
							</div>
						</div>
					...
					<div class="span3 coding project-item box">
						<div class="ch-item">
							...
							<div class="ch-info-wrap04">
								...
								<nav><a onclick="playSound('audio/cricket.mp3');"><img src="images/listen.png" alt=""></a></nav>	
									</div>	
								</div>
							</div>
							</div>
					...
					<div class="span3 coding project-item box">
						<div class="ch-item">
							...
							<nav><a onclick="playSound('audio/lion.mp3');"><img src="images/listen.png" alt=""></a></nav>									</div>
								</div>
							</div>
							</div>
						</div>
							...
							<div class="ch-info-wrap06">
								<div class="ch-info">
									...
									<div class="ch-info-back">
										...
										<span id="dummy"></span>
							<nav><a href="#">Click to Enter</a></nav>
							<nav><a onclick="playSound('audio/door.mp3');"><img src="images/listen.png" alt=""></a></nav>										</div>
								</div>
							</div>
							</div>
						</div>
					...
					<div class="span3 coding project-item box">
						...
						<nav><a onclick="playSound('audio/pop_01.mp3');"><img src="images/listen.png" alt=""></a></nav>	
									</div>
								</div>
							</div>
							</div>
							...
							<div class="ch-info-wrap">
								<div class="ch-info">
									...
									<div class="ch-info-back">
									   ...
									   <nav><a onclick="playSound('audio/roost2.mp3');"><img src="images/listen.png" alt=""></a></nav>
									</div>
								</div>
							</div>
							</div>
					...
					<div class="span3 coding project-item box">
						...
						<nav><a onclick="playSound('audio/paint_01.mp3');"><img src="images/listen.png" alt=""></a></nav>									</div>
								</div>
							</div>
							</div>
						</div>
					...
					<nav><a onclick="playSound('audio/music_01.mp3');"><img src="images/listen.png" alt=""></a></nav>										       </div>
								</div>
							</div>
						 </div>
					  </div>
			...
			<nav><a href="spelling.html">Click to Enter</a></nav>
		 	<nav><a onclick="playSound('audio/crunch_01.mp3');"><img src="images/listen.png" alt=""></a></nav>
		 						</div> <!--end of ch-info-back-->
							</div> <!--end of ch info--->
						  </div> <!end of ch-info-wrap11-->
						</div> <!--end of ch-border-->
						
					</div><!-- end ch-item -->
					</div> <!--end of box-->
					
					</li> <!--end of li from circle section-->
					</ul> <!--end of circle lists-->					
			</div> <!--end of fixed-->
		</div> <!--end of container folio-->
    </section> <!--end circle subject (called work from template) section -->
